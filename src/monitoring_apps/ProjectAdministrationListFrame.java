...
public class ProjectAdministrationListFrame extends javax.swing.JFrame {

    public ProjectAdministrationListFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnNew.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Navigation.go(ProjectAdministrationListFrame.this, new AdministrationFormFrame());
            }
        });
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProjectAdministrationListFrame().setVisible(true);
            }
        });
    }
